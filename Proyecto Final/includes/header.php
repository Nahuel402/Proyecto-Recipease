        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav text-end ">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: none; color: #222222;">
                        <?php echo $nombre; ?>
                    </a>
            ...
            <div class="p-3">
                <?php echo "<img class='rounded-circle me-2' width='50' height='50' src='$imagen'>"; ?>
            </div>
        </div>
    </div>
</nav>
